...
---properties
INSERT INTO properties (owner_id, title, description, thumbnail_cover_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code, active) VALUES (1, 'Sebastians Apartment', 'description', 'img.ca/1', 'img.ca/2', 60, 0, 1, 2, 'Canada', 'Random Street', 'Toronto', 'Ontario', 'A1A1A1', DEFAULT);
INSERT INTO properties (owner_id, title, description, thumbnail_cover_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code, active) VALUES (1, 'Sebastians Cottage', 'description', 'img.ca/3', 'img.ca/4', 200, 2, 1, 2, 'Canada', 'Random Avenue', 'Muskoka', 'Ontario', 'B2B2B2', DEFAULT);
INSERT INTO properties (owner_id, title, description, thumbnail_cover_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code, active) VALUES (1, 'Sebastians House', 'description', 'img.ca/5', 'img.ca/6', 150, 1, 2, 3, 'Canada', 'Random Road', 'York', 'Ontario', 'C3C3C3', DEFAULT);
